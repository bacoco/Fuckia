...
Read `kit/vibe-coding/constitution/agent-constitution.md` first. These laws are the root contract for the system. They are not a developer checklist.
Then read `kit/vibe-coding/constitution/agent-law-propagation.md`. Universal laws, role addenda, and validators must all exist.
...
- The 6 laws in `kit/vibe-coding/constitution/agent-constitution.md` must govern every skill, template, validator, workflow, review, and receipt.
...
5. The skill system:
   ...
   - claude-only;
   - codex-only;
   - v1 skills from `kit/vibe-coding/skills/initial-skills-and-risk-map.md`;
   - generators;
   - validators;
...
- Do not treat `kit/vibe-coding/constitution/agent-constitution.md` as passive documentation.
