...
All skills are enforcement mechanisms for `kit/vibe-coding/constitution/agent-constitution.md`.
...
```text
Start with the v1 skills listed in `kit/vibe-coding/skills/catalog/shared-v1.md`.
...
Implement risk handling from `kit/vibe-coding/skills/risks/risk-map.md`.
```
