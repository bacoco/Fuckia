...
description: Use when Claude writes or reviews specs, plans, implementation prompts, architecture reviews, UX critiques, handoff docs, code reviews, or install/migration instructions that another developer or AI agent will execute.
---
