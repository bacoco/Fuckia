...
Read `00-agent-constitution.md` first. These laws are the root contract for the system. They are not a developer checklist.
Then read `12-agent-law-propagation.md`. Universal laws, role addenda, and validators must all exist.

Read every file in this directory:

```text
/Users/macstudio/claude-codex-linear-github-collaboration-kit/
```

## Objective

- The 5 laws in `00-agent-constitution.md` must govern every skill, template, validator, workflow, review, and receipt.
...
- The system must cover the 8 failure classes in `07-failure-catalog-cross-review.md`.
- The system must deliver the initial skill set and additional mitigations in `08-initial-skills-and-risk-map.md`.
- The system must enforce `11-evidence-language-guard.md`: no uncertain causality without evidence.
...
5. The skill system:
   ...
   - claude-only;
   - codex-only;
   - v1 skills from `08-initial-skills-and-risk-map.md`;
   - generators;
   - validators;
...
- Do not treat `00-agent-constitution.md` as passive documentation.
